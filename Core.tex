...
\begin{document}
	...
	\begin{itemize}
		...
		\item We largely consider $X$ admitting a projective morphisms $X\to T$ of quasi-projective $R$-schemes. When $X \to T$ is part of the description of $X$ in this fashion, we often say $D$ is nef/ample/semiample etc, to mean that $D$ is nef/ample/semiample over $T$.
