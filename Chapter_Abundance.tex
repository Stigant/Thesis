...
%	\end{enumerate}
	...
	\begin{definition}
		...
		exists a proper $S$-morphism $f \colon X \rightarrow Y $ to an algebraic space $Y$ proper over $S$ such that for every closed subscheme $V\subseteq X$,  $\dim f(V) < \dim V$ if and only if $L|_{V}$ is not big.
	\end{definition}
