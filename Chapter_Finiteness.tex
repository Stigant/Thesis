...
\begin{document}
	...
	In this section we study termination for threefold pairs in mixed characteristic. Termination for psuedo-effective pairs in this setting is assured by the following theorem, together with the observation that if $\kappa(K_{X}+\Delta) \geq 0$ then the pair is effective. 
