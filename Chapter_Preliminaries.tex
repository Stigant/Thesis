...
In particular this includes the following Basepoint Free Theorem.

\begin{conjecture}[Basepoint Free Theorem]\label{bpt}
	...
	\begin{enumerate}
		...
		\item $\dim T>1$ and $T$ has no residue fields of char $p=2,3,5$,
	\end{enumerate}
