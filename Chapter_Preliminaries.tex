...
Over a positive characteristic field slightly less is known, even if the field is algebraically closed. 
	...
	\begin{theorem}\cite[Theorem 1.7]{BW17}\cite{Bir16}\cite[Theorem 2]{witaszek2017canonical}\cite[Proposition 6.7]{hashizume2017minimal}\label{p-MMP}
	...
	Moreover there exists a $(K_X+\Delta)$-MMP over $\kappa$ that terminatess. If in fact $(X,\Delta)$ is klt and $K_{X}+\Delta$ is pseudo-effective then every MMP terminates.
